...
class WP_CommonMark
{
  ...
  public function uncache_munged_posts()
  {
    ...
    foreach(WP_CommonMark::get_instance()->posts_to_uncache as $post_id) {
  ...
  public function submitbox_actions()
  {
    ...
    printf(
      ...
      <wrap id="wcm-markdown" style="display: none">
        <a href="#" onclick="return false;"><img %1$s class="markdown-status markdown-on" src="%2$s/assets/images/32x20-solid.png" width="32" height="20" />
        <img %1$s class="markdown-status markdown-off" src="%2$s/assets/images/32x20.png" width="32" height="20" /></a>
      </wrap>
      <script>document.getElementById("wcm-markdown").style.display = "none";</script>
